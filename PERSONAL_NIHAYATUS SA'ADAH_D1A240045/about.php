...
<body class="bg-gray-100 text-gray-800 font-sans"> 
  <!-- Header --> 
  <header class="bg-purple-600 text-white text-center p-6 text-2xl font-bold"> 
    About Me | Nihayatus Sa'adah
  </header> 
  <!-- Navigation --> 
  <nav class="bg-purple-400 text-white py-3"> 
...
. "</p>"; 
  ...
  <!-- Footer --> 
  <footer class="bg-purple-500 text-white text-center py-4 mt-10"> 
    &copy; <?php echo date('Y'); ?> | Created by Nihayatus Sa'adah 
  </footer> 
